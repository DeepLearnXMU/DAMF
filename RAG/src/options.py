...
class Options():
    ...
    def add_eval_options(self):
        self.parser.add_argument('--output_file', type=str, default='none', help='path of output data')
    ...
    def add_reader_options(self):
        ...
        self.parser.add_argument('--text_maxlength', type=int, default=100,
                        help='maximum number of tokens in text segments (dialogue)')
        self.parser.add_argument('--doc_maxlength', type=int, default=100,
                                 help='maximum number of tokens in text segments (passage)')
        ...
        self.parser.add_argument('--n_docs', type=int, default=1)
    ...
    def initialize_parser(self):
        ...
        # dataset parameters
        self.parser.add_argument('--lang', type=str, default='zh',)
